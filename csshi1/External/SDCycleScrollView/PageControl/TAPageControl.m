...
- (void)changeActivity:(BOOL)active atIndex:(NSInteger)index
{
    if (self.dotViewClass) {
        ...
        dotView.bounds = (active) ? CGRectMake(0, 0, self.currentDotImage.size.width, self.currentDotImage.size.height):CGRectMake(0, 0, self.dotImage.size.width, self.dotImage.size.height);
