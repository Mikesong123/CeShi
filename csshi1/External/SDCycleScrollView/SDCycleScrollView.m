...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        case SDCycleScrollViewPageContolStyleAnimated:
        {
            ...
            pageControl.currentDotImage = [UIImage imageNamed:@"tuijian_lunbo_icon_pressed"];
            pageControl.dotImage = [UIImage imageNamed:@"tuijian_lunbo_icon_normal"];
...
//    if (self.typeGroup) {
//        HomeChoicenessList *model = self.typeGroup[itemIndex];
//        [cell.imageView setCornerMarkImageWithType:model.type bmoth:model.bmonth freetime:model.freetime leftFreeTime:model.freeLefttime];
//    }
    ...
    if (self.delegate &&[self.delegate respondsToSelector:@selector(cycleScrollView:currentItemAtIndex:)]) {
        [self.delegate cycleScrollView:self currentItemAtIndex:itemIndex];
    }
