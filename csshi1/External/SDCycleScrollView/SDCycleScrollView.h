...
@optional
- (void)cycleScrollView:(SDCycleScrollView *)cycleScrollView currentItemAtIndex:(NSInteger)index;
...
//类型数组
@property (nonatomic, copy)  NSArray *typeGroup;
// 网络图片 url string 数组
